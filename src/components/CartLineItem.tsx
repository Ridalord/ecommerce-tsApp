...
const CartLineItem = ({item, dispatch, REDUCER_ACTIONS}: PropsType) => {
  ...
  const content = (
    <li className="cart__item">
      ...
      <div aria-label="Price Per Item">{new Intl.NumberFormat('en-NG', { style: 'currency', currency: 'NGN' }).format(item.price)}</div>
      ...
      <div className="cart__item-subtotal" aria-label="Line Item Syubtotal">
